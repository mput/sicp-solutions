...
(define (test-carmichaels number)
  ...
  (cond ((and (iter-test number 1) (not (isPrime number)))
         (newline)(display "is carmichaels number: ")(display number)(newline))
        ((and (iter-test number 1) (isPrime number))
         (newline)(display "is Prime number: ")(display number)(newline))
        (else (newline)(display "Just number: ")(display number)(newline))))
